...
- PHP
  ...
  - [穿透Laravel](/php/穿透laravel/README.md)
    - [第一章：基础环境搭建](/php/穿透laravel/01第一章：基础环境搭建/README.md)
    - [第二章：核心代码结构分析](/php/穿透laravel/02第二章：核心代码结构分析/README.md)
    - [第三章：实现自动加载](/php/穿透laravel/03第三章：实现自动加载/README.md)
    - [第四章：艰难的开始](/php/穿透laravel/04第四章：艰难的开始/README.md)
    - [第五章：陷入困境](/php/穿透laravel/05第五章：陷入困境/README.md)
    - [第六章：继续前行](/php/穿透laravel/06第六章：继续前行/README.md)
    - [第七章：解析HTTP内核](/php/穿透laravel/07第七章：解析HTTP内核/README.md)
    - [第八章：处理请求](/php/穿透laravel/08第八章：处理请求/README.md)
    - [第九章：渲染页面](/php/穿透laravel/09第九章：渲染页面/README.md)
    - [第十章：终止程序](/php/穿透laravel/10第十章：终止程序/README.md)
    - [结束语](/php/穿透laravel/11结束语/README.md)
    - [附录一：断点测试和中断测试](/php/穿透laravel/附录一：断点测试和中断测试/README.md)
    - [附录二：Container之instance方法](/php/穿透laravel/附录二：Container之instance方法/README.md)
    - [附录三：Container之resolve方法](/php/穿透laravel/附录三：Container之resolve方法/README.md)
    - [附录四：Container之bind方法](/php/穿透laravel/附录四：Container之bind方法/README.md)
    - [附录五：Container之resolveDependencies方法](/php/穿透laravel/附录五：Container之resolveDependencies方法/README.md)
    - [附录六：Application之register方法](/php/穿透laravel/附录六：Application之register方法/README.md)
    - [附录七：Dispatcher之dispatch方法](/php/穿透laravel/附录七：Dispatcher之dispatch方法/README.md)
    - [附录八：扩展自动注册(Package_auto_discovery)](/php/穿透laravel/附录八：扩展自动注册(Package_auto_discovery)/README.md)
...
- Golang 基础入门
  - Go基础
    ...
    - [Init函数和main函数](/Golang基础入门/go基础/Init函数和main函数.md)
    - [运算符](/Golang基础入门/go基础/运算符.md)
    - [下划线](/Golang基础入门/go基础/下划线.md)
    - [基本类型](/Golang基础入门/go基础/基本类型.md)
    - [内置变量类型和函数](/Golang基础入门/go基础/内置变量类型和函数.md)
    - [变量和常量使用](/Golang基础入门/go基础/变量和常量.md)
    - [数组](/Golang基础入门/go基础/数组.md)
    - [切片Slice](/Golang基础入门/go基础/切片Slice.md)
    - [指针](/Golang基础入门/go基础/指针.md)
    - [MAP](/Golang基础入门/go基础/map.md)
    - [结构体](/Golang基础入门/go基础/结构体.md)
    - [接口](/Golang基础入门/go基础/接口.md)
    - [Channel](/Golang基础入门/go基础/channel.md)
  - 流程控制
    - [条件语句if](/Golang基础入门/流程控制/if.md)
    - [条件语句switch](/Golang基础入门/流程控制/switch.md)
    - [条件语句select](/Golang基础入门/流程控制/select.md)
...
- Golang
  ...
  - 第三方库推荐
    ...
    - [gomail](/golang/third_libraries/gomail.md)
    - [zerolog](/golang/third_libraries/zerolog.md)
    - [zap](/golang/third_libraries/zap.md)
    - [cast](/golang/third_libraries/cast.md)
    - [viper](/golang/third_libraries/viper.md)
    - [cobra](/golang/third_libraries/cobra.md)
    - [pflag](/golang/third_libraries/pflag.md)
    - [sonic](/golang/third_libraries/sonic.md)
    - [validator](/golang/third_libraries/validator.md)
    - [gopay](/golang/third_libraries/gopay.md)
    - [jwt](/golang/third_libraries/jwt.md)
    - [go-elasticsearch](/golang/third_libraries/go_elasticsearch.md)
    - [grpc-go](/golang/third_libraries/grpc_go.md)
    - [air](/golang/third_libraries/air.md)
